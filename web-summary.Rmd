...
**The following plots show the observed (dashed line) and projected daily number of recorded cases and deaths for the three scenarios.
Shaded regions represent the area within which 95% of the model simulations fall.**
