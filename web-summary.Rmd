...
Grey bars reporesent reporeted data and the black line represents the fit of our model to observed data.
...
![](output/figures/scenarios-legend.png){ width=700px }
...
2. **Maintain social distancing (status quo).** Maintaining social distancing at the level last observed on April 26 maintains human movements at 74% of normal.
3. **Relax social distancing.** Relaxing social distancing increases human movements from the current level to 80% of normal.
4. **Return to normal.** Ending social distancing increases human movements from the current level to 100% of normal. 

*Effectiveness scenarios (past and future)*

5. **What if social distancing had continued to increase?** Human movement patterns show that social distancing began to relax around April 10. In this scenario, we explore how the epidemic would have developed if social distancing had continued to increase (and human movements had continued to decreased) until it reached the level observed in New York. 
6. **What if social distancing had never begun?** To assess the effectiveness of the March 14 and March 23 interventions, we simulate forward from March 1 assuming that no social distancing had been enacted.
...
<!-- For more details, see the [public GitHub repository](https://github.com/CEIDatUGA/COVID-GA-model). -->
