...
![](output/figures/scenarios-legend-norelax.png){ width=700px }
...
3. **Relax social distancing.** Relaxing social distancing increases human movements from the current level to 80% of normal. UPDATE: As of May 14, this scenario is no longer relevant, as human movements have already returned to greater than 80% of normal. Therefore we no longer consider this scenario. 
