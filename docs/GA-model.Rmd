...
$\phi(t)$ is the human mobiltiy metric shown in the figure above, and
...
We also included  process noise on the rate of tranmission ($\beta(t)$) at each time step, such that $\beta(t) = \frac{\beta}{N} \psi(t) \phi(t) \Gamma(t)$.
