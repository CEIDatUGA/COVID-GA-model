...
des_string <- c("MIF id", "Log Likelihood", "SE of Log Likelihood", 
                ...
                "Time at which infection detection fraction is at 50% of max",
                ...
                rep("Spline coefficient", 9),
                "Initial number of susceptible individuals",
                "Initial number of latent infectious individuals",
                "Initial number of asymptomatic individuals",
                "Initial number of symptomatic, undetected individuals",
                "Initial number of symptomatic, detected individuals",
                "Initial number of diagnosed cases",
                "Initial number of hospitalized cases",
                "Initial number of recovered individuals",
                "Initial number of deaths after hospitalization",
                "Trend")
...
res$partable_natural %>%
  ...
  filter(!Parameter %in% c("MIF_ID", "LogLik", "LogLik_SE", "trend_start")) %>%
